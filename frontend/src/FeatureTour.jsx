...
const STEPS = [
  ...
  },
  {
    ...
    side: 'left',
    title: '07 — Source Attribution Overlay',
  ...
  },
  {
    ...
    side: 'bottom',
    title: '08 — Multilingual Citizen Advisory',
    body: 'The scrolling banner cycles through actionable public health advisories in English, Hindi, and Kannada — auto-derived from the dominant CPCB band. Two audience variants: general public and sensitive groups (children, elderly, respiratory patients). This is the citizen-facing output layer, not just an admin tool.',
